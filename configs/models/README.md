...
|---|---|---|---|
| `gemma3_4b`（預設） | Gemma Terms of Use | 4.25 GiB | 好，但 fp16 數值最敏感 |
| `qwen2_5_vl_7b` | Apache 2.0 | 6.43 GiB | 好 |
...
一個。看到 loss 變 nan：先確認 unsloth 是最新版，再把 `train.learning_rate` 從本次
使用的 `2e-4` 降到 `1e-4`。
